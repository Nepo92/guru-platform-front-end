...
import SectionTemplates from '../../templates/knowledgeTemplates.js';
...
class AddSection {
  ...
  saveSection(menu, name, e) {
    ...
    if (validation.validateSection(name)) {
      ...
      const isGeneral = page === 'bookmarks' ? knowledgeBaseAPI.saveSection(data) : null;
      const isAdvertiser = page === 'advertiser' ? knowledgeBaseAPI.saveSectionAdvertiser(data) : null;
      const isManagement = page === 'management' ? knowledgeBaseAPI.saveSectionManagement(data) : null;
      const isManager = page === 'manager' ? knowledgeBaseAPI.saveSectionManager(data) : null;
