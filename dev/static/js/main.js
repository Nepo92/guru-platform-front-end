$(document).ready(function () {
  ...
  $openMobileMenu.click(function () {
    $mobileMenu.show();
    $("[js-open-mobile-menu]").addClass("is-open");
    $("body").css({ overflow: "hidden" });
  });

  $closeMobileMenu.click(function () {
    $mobileMenu.hide();
    $("[js-open-mobile-menu]").removeClass("is-open");
...
function validateForm(form) {
  ...
  if ($(form).data("validator")) {
    $(form).data("validator").settings.ignore = ":hidden:not(#tariffValue)";
  }
